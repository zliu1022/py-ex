...
def day_data(daima,start_date,end_date,fuquan):
    ...
    def get_xueqiu(daima,start_date,end_date,fuquan):
        ...
        #t_str = 'https://xueqiu.com/stock/forchartk/stocklist.json?symbol='+daima_new+'&period=1day&type='+fuquan+'&begin='+start_time+'&end='+end_time+'&_='+end_time
        #t_str = 'https://stock.xueqiu.com/v5/stock/chart/kline.json?symbol=SZ002475&begin=1646833014212&period=day&type=before&count=-284&indicator=kline,pe,pb,ps,pcf,market_capital,agt,ggt,balance'
        t_str = 'https://stock.xueqiu.com/v5/stock/chart/kline.json?symbol='+daima_new+'&period=day&type='+fuquan+'&begin='+start_time+'&end='+end_time+'&_='+end_time
        print(t_str)
        r = s.get(t_str ,headers = header)
...
day_data('002475','20210101','20220705','before')
